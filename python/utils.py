...
def plot_candle(ohlc, xlabel="Date", ylabel="Price [$]", width=0.6, colorup='green', colordown='red', alpha=0.8, **kwargs):
    fig, ax = plt.subplots()
...
def plot_line(x, y, xlabel="x", ylabel="y", horizontal=[], **kwargs):
    if horizontal:
...
def plot_hist(values, xlabel="Values", ylabel="Frequency", axisrange=None, nbins=50, density=False, color="royalblue", alpha=0.5, legend="", **kwargs):
